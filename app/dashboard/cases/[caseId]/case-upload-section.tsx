...
export function CaseUploadSection({ caseId }: CaseUploadSectionProps) {
  ...
  return (
    <section className="rounded-md border border-slate-200 bg-white px-4 py-4">
      ...
      <button
        type="button"
        className="mt-4 w-full rounded-md bg-slate-950 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-300 sm:w-auto"
